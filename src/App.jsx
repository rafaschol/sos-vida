...
const navigation = [
  ...
  { name: "Emergencias", href: "#", current: false },
        ...
        <main>
          <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            ...
            <div className="px-4 py-6 sm:px-0">
              ...
              <List
                title="Estadísticas"
                subtitle="Conoce algunos resultados de SOS Vida"
                elements={[
                  { id: 1, key: "Usuarios totales", value: "15" },
                  { id: 2, key: "Encuestas totales contestadas", value: "48" },
                  { id: 3, key: "Personas asistidas", value: "46" },
                  { id: 3, key: "Comunicaciones brindadas", value: "32" },
                ]}
              />
              ...
              <div className="overflow-hidden bg-white shadow sm:rounded-lg mt-8">
                <div className="px-4 py-5 sm:px-6">
                  ...
                  <p className="mt-1 max-w-2xl text-sm text-gray-500">
                    Consulta mediante los siguientes gráficos otros datos de
                    interés
                  </p>
                </div>
